...
-- Alter column "cdc_case_earliest_dt" to match the dataset
...
CREATE TABLE covid_data (
    ...
    death_yn VARCHAR (40),
    medcond_yn VARCHAR(40),
	PRIMARY KEY (race_ethnicity_combined) V
);
...
CREATE TABLE population (
	...
	--FOREIGN KEY(race_ethnicity_combined) REFERENCES covid_19_data( race_ethnicity_combined)
);
